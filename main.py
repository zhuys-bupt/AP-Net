...
parser.add_argument('--batch_size', type=int, default=16, help='training batch size')   # 12
...
parser.add_argument('--summary_freq', type=int, default=21, help='the frequency of saving summary')
parser.add_argument('--save_freq', type=int, default=1, help='the frequency of saving checkpoint')

parser.add_argument('--device', default='cuda', help='device to use for training / testing')

parser.add_argument('--train_num_workers', type=int, default=8, help='training batch size')   # 12
parser.add_argument('--test_num_workers', type=int, default=4, help='testing batch size')
...
TrainImgLoader = DataLoader(train_dataset, args.batch_size, shuffle=True,
                            num_workers=args.train_num_workers, drop_last=True)  # 6
TestImgLoader = DataLoader(test_dataset, args.test_batch_size, shuffle=False,
                           num_workers=args.test_num_workers, drop_last=False)
